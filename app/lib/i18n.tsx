...
const translations = {
    tr: {
        ...
        // Trust Layer
        trustLayer: {
            heroTagline: "Excel hesaplar. BotExcel kanıtlar.",
            signatureHook: "Bu Excel'in altına imza atabilir misiniz?",
            signatureHookSub: "Eğer cevap \"emin değilim\" ise, BotExcel sizin için var.",
            trustScore: "Güven Skoru",
            trustScoreDesc: "Bu Excel ne kadar güvenilir?",
            sourceCoverage: "Kaynak Kapsama",
            sourceCoverageDesc: "Verilerin kaynağa bağlı olma oranı",
            ruleCompliance: "Kural Uyumu",
            ruleComplianceDesc: "İş kurallarına uygunluk",
            changeTrail: "Değişiklik İzi",
            changeTrailDesc: "Kim, ne zaman, neyi değiştirdi",
            outputQuality: "Çıktı Kalitesi",
            outputQualityDesc: "Excel standartlarına uygunluk",
            improveScore: "Skoru Yükselt",
            proofPackage: "Kanıt Paketi",
            proofPackageDesc: "Her dönüşüm, denetim hazır kanıt paketiyle birlikte gelir.",
            downloadProof: "Proof Package İndir",
            proofPdf: "Yönetici özeti (PDF)",
            proofAudit: "Denetim logu (NDJSON)",
            proofSources: "Kaynak hash'leri",
            proofWorkbook: "Korumalı Excel çıktısı",
        },
        // Common
        common: {
    ...
    en: {
        ...
        // Trust Layer
        trustLayer: {
            heroTagline: "Excel calculates. BotExcel proves.",
            signatureHook: "Can you sign this Excel?",
            signatureHookSub: "If the answer is \"not sure\", BotExcel is for you.",
            trustScore: "Trust Score",
            trustScoreDesc: "How reliable is this Excel?",
            sourceCoverage: "Source Coverage",
            sourceCoverageDesc: "Percentage of data linked to sources",
            ruleCompliance: "Rule Compliance",
            ruleComplianceDesc: "Adherence to business rules",
            changeTrail: "Change Trail",
            changeTrailDesc: "Who changed what, when",
            outputQuality: "Output Quality",
            outputQualityDesc: "Conformance to Excel standards",
            improveScore: "Improve Score",
            proofPackage: "Proof Package",
            proofPackageDesc: "Every conversion comes with an audit-ready proof package.",
            downloadProof: "Download Proof Package",
            proofPdf: "Executive summary (PDF)",
            proofAudit: "Audit log (NDJSON)",
            proofSources: "Source hashes",
            proofWorkbook: "Protected Excel output",
        },
        // Common
        common: {
