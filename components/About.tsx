...
const experiences = [
  {
    ...
    title: "İçe Aktar",
    company: "",
    description: "PDF/görsel/ekstreyi yükleyin; BotExcel işi devralsın.",
    icon: Briefcase,
  },
  {
    year: "Adım 02",
    title: "Ayıkla & Eşle",
    company: "",
    description: "Satırları doğru alanlara bağlar; dağınıklığı toplar.",
    icon: Briefcase,
  },
  {
    year: "Adım 03",
    title: "Standart Düzen",
    company: "",
    description: "Tek şablon, tek anlam: her dosyada aynı düzen.",
    icon: Briefcase,
  },
  {
    year: "Adım 04",
    title: "Kontrol Et (PRO)",
    company: "",
    description:
      "Toplam/KDV/tarih tutarlılığını denetler; güven skoru verir.",
    icon: Trophy,
  },
  {
    year: "Adım 05",
    title: "Kanıtla (PRO)",
    company: "",
    description: "Karar geçmişi ve kaynak iziyle “denetime hazır” paket üretir.",
    icon: GraduationCap,
  },
];
            ...
            >
              ...
              >
                ...
                <span className="relative inline-block">
                  <span className="gradient-animated-text">kontrol edilebilir</span>
                  <span
                    ref={glow1Ref}
                ...
                {" "}
                <span className="relative inline-block">
                  <span className="gradient-animated-text">bir süreç üretin.</span>
                  <span
                    ref={glow2Ref}
                    className="absolute inset-0 gradient-animated-text blur-xl opacity-60"
                  >
              ...
              >
                <p>
                  Excel dosyası üretmek kolaydır. Zor olan, o dosyanın neyi
                  temsil ettiğini herkesin aynı şekilde anlayabilmesidir.
                  BotExcel, belge verisini tek bir standart düzene bağlar; aynı
                  çıktıyı her seferinde aynı mantıkla üretir.
                </p>
                <p>
                  Sonuç: Çıktı “kontrol edilmesi gereken bir dosya” olmaktan
                  çıkar. Okunur, özetlenmiş ve yönetilebilir bir operasyon
                  çıktısına dönüşür.
                </p>
                <p>
                  Ekip içi onay hızlanır, raporlama akışı kopmaz.
                </p>
              </div>
            </div>
