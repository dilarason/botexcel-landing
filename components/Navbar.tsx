...
const navLinks = [
  { name: "Ürün", href: "#about" },
  { name: "Nasıl Çalışır", href: "#process" },
  { name: "Excel Add-in", href: "#services" },
  { name: "Çözümler", href: "#posts" },
];
    ...
    switch (status) {
      case "online":
        return {
          ...
          headline: "ONLINE",
          message:
            "Sistem açık. Yükleme ve dışa aktarma çalışıyor.",
      ...
      case "holidays":
        return {
          ...
          headline: "BAKIMDA",
          message:
            "Planlı bakım. Bazı işlemler gecikebilir.",
          color: "bg-amber-500",
      ...
      default:
        return {
          ...
          headline: "OFFLINE",
          message:
            "Geçici kesinti. Lütfen daha sonra tekrar deneyin.",
          color: "bg-zinc-500",
    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-between">
          <Link
            href="/"
            className="flex items-center -mt-5 transition-opacity relative z-50 cursor-pointer"
          ...
          >
            ...
            />
            <span className="ml-2 text-base sm:text-lg font-semibold tracking-wide text-white hidden sm:inline">
              BotExcel
            </span>
          </Link>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3 mb-6 relative z-10">
              <div className="p-3 rounded-xl bg-white/5 border border-white/5 hover:border-white/10 transition-colors">
                ...
                <div className="text-sm text-white font-medium">Türkiye</div>
              </div>
              <div className="p-3 rounded-xl bg-white/5 border border-white/5 hover:border-white/10 transition-colors">
                <div className="flex items-center gap-2 text-gray-400 mb-1">
              ...
              <div className="p-3 rounded-xl bg-white/5 border border-white/5 hover:border-white/10 transition-colors">
                ...
                <div className="text-sm text-white font-medium">Stabil</div>
              </div>
            </div>
            ...
            <div className="mb-6 relative z-10 bg-white/5 rounded-xl p-4 border border-white/5">
              ...
              <p className="text-xs text-gray-400 leading-relaxed">
                Bu gösterge BotExcel’in çalışma durumunu ve kuyruğu yansıtır.
                Canlı güncellenir; yükleme, dönüşüm ve dışa aktarma erişimini
                görürsünüz.
              </p>
            </div>
