...
const steps = [
  {
    icon: MessageSquare,
    title: "Akıllı Okuma (OCR/QR)",
    description: "PDF/görseli okur; alanları güvenle çıkarır.",
  },
  {
    icon: PenTool,
    title: "Tablo Ayrıştırma",
    description: "Karmaşık sayfayı satır/sütuna doğru böler.",
  },
  {
    icon: Code2,
    title: "Şablon & Eşleştirme",
    description: "Düzeni öğrenir; alanları doğru kolona bağlar.",
  },
  {
    icon: Rocket,
    title: "Standart Excel Çıktısı",
    description: "Tek şablonda, paylaşıma hazır tablo üretir.",
  },
  {
    icon: Rocket,
    title: "Alan Doğrulama (PRO)",
    description: "KDV/toplam/tarih/format kontrolleri yapar.",
  },
  {
    icon: Rocket,
    title: "Formül & Tutarlılık (PRO)",
    description: "Hesapları doğrular; hatayı dosyada yakalar.",
  },
  {
    icon: Rocket,
    title: "Kaynak İzi (PRO)",
    description: "Hücreyi kaynağına bağlar: “nereden geldi?” biter.",
  },
  {
    icon: Rocket,
    title: "Kanıt Paketi (PRO)",
    description:
      "Kontrol özeti + karar geçmişiyle denetime hazır teslim.",
  },
];
    ...
    rafId.current = requestAnimationFrame(() => {
      ...
      if (glowRef.current) {
        gsap.set(glowRef.current, {
          background: `radial-gradient(300px circle at ${x * 100}% ${y * 100
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div ref={headerRef} className="mb-12 md:mb-16 lg:mb-20 text-center">
          ...
          >
            ...
            >
              <span className="relative inline-block">
                <span className="gradient-animated-text">net sonuç.</span>
                <span
                  ref={glowRef}
          ...
          >
            Belgeyi okur, tabloya çevirir, kontrol eder ve kanıtıyla birlikte
            teslim eder.
            <br />
            Sonuç: ekipte aynı anlam, denetimde aynı güven.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 relative">
          ...
          {steps.map((step, index) => {
            if (step.title === "Akıllı Okuma (OCR/QR)") {
              return (
                <ContactStep
                  key={index}
                  step={step}
