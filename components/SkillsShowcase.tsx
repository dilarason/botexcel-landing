...
const skills = [
  {
    ...
    title: "Akışı kurun",
    subtitle: "Çözümler",
    description: "Dönüşüm tek iş değil; ekibin standart süreci olsun.",
    details: [
      "Tek yerden iş başlatma",
      "Toplu iş kuyruğu",
      "Ekip paylaşımı",
      "Yetki/erişim düzeni",
    ],
  ...
  {
    id: "backend",
    title: "Şirket standardı",
    subtitle: "Çözümler",
    description: "Aynı dosya, her kullanıcıda aynı anlamla okunsun.",
    details: [
      "Kolon sözlüğü (standart alanlar)",
      "Şablon paylaşımı",
      "Tek tip çıktı kuralı",
      "Raporlama uyumu",
    ],
    icon: Server,
    color: "#8B5CF6",
  ...
  {
    id: "web3",
    title: "Özetle yönetin",
    subtitle: "Çözümler",
    description: "Dosyayı okumayın; istisnaları yönetin.",
    details: [
      "Kritik alanlar görünür",
      "Uyarıların nedeni yazılı",
      "Hızlı kontrol görünümü",
      "Paylaşılabilir özet",
    ],
    icon: Coins,
    color: "#F59E0B",
  ...
  {
    id: "ai",
    title: "Denetime hazır iz",
    subtitle: "Çözümler",
    description: "“Kim, neyi, neden?” sorusunun cevabı dosyada dursun.",
    details: [
      "İşlem geçmişi kaydı",
      "Karar notları & açıklamalar",
      "Kaynağa dönük iz (PRO)",
      "Kanıt paketi (PRO)",
    ],
    icon: Bot,
    color: "#EC4899",
  ...
  {
    id: "devops",
    title: "Excel Add-in ile",
    subtitle: "Çözümler",
    description: "Excel’in içinde doğrula, düzelt, yeniden üret.",
    details: [
      "Hücrede açıklama/uyarı gör",
      "Tek tık kontrol çalıştır (PRO)",
      "Kaynağa git / işaretle (PRO)",
      "Paylaş/arsiv akışına bağla",
    ],
    icon: CloudCog,
    color: "#10B981",
