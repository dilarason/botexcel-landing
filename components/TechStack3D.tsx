      ...
      >
          ...
          <div className="p-6 font-mono text-sm leading-relaxed text-slate-300">
            <div className="flex gap-4">
              ...
              <p>
                ...
                <span className="text-primary-light">BotExcel</span> ={" "}
                <span className="text-yellow-400">await</span>{" "}
                <span className="text-primary-light">Motor</span>.
            ...
            <div className="flex gap-4">
              ...
              <p className="pl-8">
                <span className="text-orange-400">&quot;OCR&quot;</span>,{" "}
            ...
            <div className="flex gap-4">
              ...
              <p className="pl-8">
                <span className="text-primary">&quot;Doğrulama&quot;</span>,{" "}
            ...
            <div className="flex gap-4">
              ...
              <p className="pl-4">
                odak: <span className="text-secondary">Netlik</span>
              </p>
            </div>
            <div className="flex gap-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between p-2 rounded-lg bg-white/5 border border-white/5">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] text-slate-300">Veri Deposu</span>
                </div>
        ...
        >
          ...
          <div className="p-3 font-mono text-[10px] text-primary-light">
            ...
            <p className="text-secondary-light">🚀 Excel çıktısı hazır</p>
          </div>
        </div>
      </div>
    </div>
